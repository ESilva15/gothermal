...
// getUserPass will return the password (encrypted) of the user that is trying to log in
...
// insertToken will insert the token generated by a successful authentication
...
// getSessionData returns the data of a session for a given token
